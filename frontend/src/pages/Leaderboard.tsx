...
import { Trophy, House, ChevronLeft, ChevronRight } from "lucide-react";
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <div className="text-slate-400 text-sm">
                Top players ranked by efficiency
              </div>
            </div>
          </div>
          <button
                ...
                {loading ? (
                  ...
                  data.map((entry, index) => {
                    ...
                    return (
                      <tr
                        key={index}
                        className="hover:bg-slate-700/50 transition duration-150 group"
                      >
                        <td className="p-5 font-bold text-slate-500 group-hover:text-slate-700">
                          <span
                            className={`inline-flex items-center justify-center w-10 h-10 rounded-full p-2 ${
                              rank === 1
